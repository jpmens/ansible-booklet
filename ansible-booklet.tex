...
Playbooks. Users can also write their own modules. These modules can control
system resources, like services, packages, or files (anything really), or
handle executing system commands. The following is a list of modules in the
core library with supported options (\man{} is mandatory, \opt{} optional). (If
you're viewing this in a PDF reader, click on the module name for its
